...
export default function MovieResultCard({
  ...
  useEffect(() => {
    ...
    setPoster("/poster-placeholder.jpg");
    setImdbId(null);
    setTmdbId(null);
    setSummary("");
    ...
    fetchMovieMeta(cleanTitle, year).then(
      ({
        posterUrl,
        imdbId,
        tmdbId,
  ...
  useEffect(() => {
    ...
    fetch(
      ...
      .then((data) => {
        ...
        const movieLink = countryData.link;
  ...
  return (
    <div className={cardClassName}>
      ...
      <div className="absolute top-2 right-2 flex items-center bg-black/70 px-1 py-0.5 rounded-md">
        <img
      ...
      <div className={contentClassName}>
        ...
        {tone && (
          <p className="text-xs sm:text-sm text-mist-blue leading-tight">
            <span className="font-medium text-bright-amber">
              Tone:
            </span>{" "}
            {tone}
          </p>
